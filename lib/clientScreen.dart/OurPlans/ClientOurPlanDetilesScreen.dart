...
class Clientourplandetilesscreen extends StatefulWidget {
  const Clientourplandetilesscreen({super.key});

  @override
  State<Clientourplandetilesscreen> createState() =>
      _ClientourplandetilesscreenState();
}

class _ClientourplandetilesscreenState
    extends State<Clientourplandetilesscreen> {
            ...
            Padding(
              ...
              child: Column(
                children: [
                    ...
                    child: ClipRRect(
                      ...
                      child: Table(
                        ...
                        children: [
                          /// Header Row
                          TableRow(
                            decoration: BoxDecoration(color: Color(0xffF2D500)),
                            children: [
                      ...
                      child: Table(
                        ...
                        children: [
                          ...
                          TableRow(
                            ...
                            children: [
                              tableCell("3-4 units"),
                              tableCell("GHS 229/month"),
                              tableCell("GHS 379/month"),
                            ],
                          ),
                  ...
                  SizedBox(height: 2.h),
                  Text(
                    "What’s Planed: Wiring, fuse box, switches, sockets, light fittings,\n ceiling fans, accidental damage.",
                    style: GoogleFonts.outfit(
                      fontSize: 13.sp,
                      fontWeight: FontWeight.w500,
                      letterSpacing: -0.5,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border(
                                top: BorderSide(color: AppColors.buttonText),
                                bottom: BorderSide(color: AppColors.buttonText),
                              ),
                            ),
                            child: Text(
                              "Tier 1 (1–2 bedrooms)",
