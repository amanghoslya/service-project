...
CGetMyPlanRequestModel cGetMyPlanRequestModelFromJson(String str) => CGetMyPlanRequestModel.fromJson(json.decode(str));

String cGetMyPlanRequestModelToJson(CGetMyPlanRequestModel data) => json.encode(data.toJson());
...
class CGetMyPlanRequestModel {
    ...
    factory CGetMyPlanRequestModel.fromJson(Map<String, dynamic> json) => CGetMyPlanRequestModel(
...
class Declaration {
    ...
    factory Declaration.fromJson(Map<String, dynamic> json) => Declaration(
        ...
        electronicSignature: electronicSignatureValues.map[json["electronicSignature"]]!,
    ...
    Map<String, dynamic> toJson() => {
        ...
        "electronicSignature": electronicSignatureValues.reverse[electronicSignature],
        "date": date?.toIso8601String(),
    };
}

enum ElectronicSignature {
    ALI,
    JOHN_DOE,
    VSHSHHS
}
...
class PaymentAndBilling {
    ...
    factory PaymentAndBilling.fromJson(Map<String, dynamic> json) => PaymentAndBilling(
        ...
        howDidYouHearAboutUs: howDidYouHearAboutUsValues.map[json["howDidYouHearAboutUs"]]!,
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "howDidYouHearAboutUs": howDidYouHearAboutUsValues.reverse[howDidYouHearAboutUs],
    };
}
...
class PlanId {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "status": planIdStatusValues.reverse[status],
...
enum Description {
    BASIC_AC_MAINTENANCE_AND_SUPPORT_PLAN,
    NKNN
}

final descriptionValues = EnumValues({
    "Basic AC maintenance and support plan": Description.BASIC_AC_MAINTENANCE_AND_SUPPORT_PLAN,
...
final planIdStatusValues = EnumValues({
    "active": PlanIdStatus.ACTIVE
});
...
final tierValues = EnumValues({
    "Premium Plan": Tier.PREMIUM_PLAN,
    "Tier 1": Tier.TIER_1
});
